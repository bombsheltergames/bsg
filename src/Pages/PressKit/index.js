      ...
      <main className="PressKit">
        ...
        <div className="PressKit-wrapper">
          <nav className="PressKit-sidebar">
            ...
            <a href="/presskit/#bsg-llc">Bomb Shelter Games LLC Info</a>
          ...
          <div className="PressKit-main">
            ...
            <section className="PressKit-main-description">
              <aside>
                <h2>
              ...
              <div>
                ...
                <p>
                  ...
                  massive vibration deep in the ocean, Abe Douglas, the
                  commander who assembled the crew, makes it his responsibility
              ...
              <ul>
                <li>
                  ...
                  <p>
                    ...
                    unique tools to uncover your environment, including tow
                    lines that help you pull through heavy currents, and a
                    sonarsystem that helps you navigate through pitch black
                    darkness.
                  </p>
                </li>
                <li>
                ...
                <li>
                  ...
                  <p>
                    ...
                    uncover the mystery of the signal coming from the ocean
                    floor.
                  </p>
                </li>
                <li>
                  ...
                  <p>
                    Unlock a wide variety of weapons to help you battle
                    monstrous bosses, survive tense set-pieces, and uncover
                    secrets that expand the story and your chances of survival.
                  </p>
                </li>
              </ul>
            </MainSection>
            ...
            <MainSection noPadding alt topDivider bottomDivider>
              ...
              <p>
                &ldquo;Most Compelling Game Mechanics&rdquo; - Boston Festival
                of Indie Games (2018)
              </p>
            </MainSection>
            <MainSection noPadding>
            ...
            <MainSection noPadding>
              <h2>
                <span id="bsg-llc">Bomb Shelter Games LLC Info</span>
              </h2>
              <p>
                Bomb Shelter Games LLC is a Boston-based indie developer founded
                in 2009 that previously worked exclusively on PC and mobile
                games. Depths of Sanity is our first multi-platform release.
              </p>
            </MainSection>
            <MainSection noPadding>
              <h2>
